...
echo (set_color FF55BB)"Sending Mesages from W1-->W1 == Sepolia"
echo "--------------------------------------"
cast send \
    $W1 \
    --private-key $W1K \
...
echo " ╚═╝     ╚═╝  ╚═════╝  ╚═╝     ╚═╝ ╚═════╝  ╚═╝  ╚═╝ ╚═╝"
echo ""
echo (set_color 97FEED)"Sending Mesages from W1-->W1 == Mumbai"
echo "--------------------------------------"
cast send \
    $W1 \
    --private-key $W1K \
...
echo "--------------------------------------"
echo "--------------------------------------"
echo (set_color yellow)"Sending Mesages from W2-->W2 == Mumbai"
echo "--------------------------------------"
cast send \
    $W2 \
    --private-key $W2K \
